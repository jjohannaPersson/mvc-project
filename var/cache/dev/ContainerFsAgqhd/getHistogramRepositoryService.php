 ...
 */
class getHistogramRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HistogramRepository' shared autowired service.
     *
     * @return \App\Repository\HistogramRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HistogramRepository.php';

        return $container->privates['App\\Repository\\HistogramRepository'] = new \App\Repository\HistogramRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
