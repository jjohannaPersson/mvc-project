...
return [
    ...
    [ // $dynamicRoutes
        ...
        196 => [[['_route' => 'app_highscore_update', '_controller' => 'App\\Controller\\HighScoreController::update'], ['id'], null, null, false, true, null]],
        225 => [
            [['_route' => 'app_histogram_update', '_controller' => 'App\\Controller\\HistogramController::update'], ['id'], null, null, false, true, null],
