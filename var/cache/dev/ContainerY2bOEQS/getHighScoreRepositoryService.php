 ...
 */
class getHighScoreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HighScoreRepository' shared autowired service.
     *
     * @return \App\Repository\HighScoreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HighScoreRepository.php';

        return $container->privates['App\\Repository\\HighScoreRepository'] = new \App\Repository\HighScoreRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
